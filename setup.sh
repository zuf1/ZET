...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/jhall031/testkdn/main/ipvps | grep $MYIP )
if [ $MYIP = $IZIN ]; then
...
wget https://raw.githubusercontent.com/zuf1/ZET/main/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget https://raw.githubusercontent.com/zuf1/ZET/main/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
wget https://raw.githubusercontent.com/zuf1/ZET/main/ins-vt.sh && chmod +x ins-vt.sh && sed -i -e 's/\r$//' ins-vt.sh && screen -S v2ray ./ins-vt.sh
wget https://raw.githubusercontent.com/zuf1/ZET/main/ipsec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
...
echo ""  | tee -a log-install.txt
echo "---------------------------------------   ZET TV   -----------------------------------------" | tee -a log-install.txt
echo ""
echo " Reboot 10 Sec"
sleep 10
reboot
